...
\newcommand{\Titel}{Skabelon}   % Vedrørende
\newcommand{\Sagsbehandler}{Sags Behandlersen}   % Sagsbehandler
\newcommand{\Email}{sb@adm.ku.dk} % Email
\newcommand{\Koncern}{Rektoratets Stab}     % Koncern
\newcommand{\Enhed}{Analyse og Business Intelligence} % Enhed
\newcommand{\Reference}{XX}   % Reference-ID XX ???
...
\begin{paracol}{2}
    ...
    \switchcolumn
    \begin{tcolorbox}[blanker, breakable, width=\linewidth]
        \hfill\includegraphics[width=1.27in]{S:/FAD-REKSEK-REKSTAB-ABI-Analyse/quarto/latex_skabelon/KU-logo.png}
    \end{tcolorbox}
\end{paracol}
...
\section{Overskrift}\label{overskrift}

\subsection{Mindre overskrift}\label{mindre-overskrift}

\subsubsection{Endnu mindre overskrift}\label{endnu-mindre-overskrift}

Brødtekst, hvor et mellemrum:

~

skal angives med html.
